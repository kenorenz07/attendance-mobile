...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'class-details',
        component: () => import('@/views/student_dashboard/ClassDetails.vue')
      },
      {
        path: 'tab2',
        component: () => import('@/views/student_dashboard/Tab2.vue')
      },
      {
        path: 'tab3',
        component: () => import('@/views/student_dashboard/Tab3.vue')
      }
    ]
  },
  {
